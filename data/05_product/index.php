...
/*//1.获取轮播广告项
$sql = "SELECT cid,img,title,href FROM kj_index_carousel";
$result = mysqli_query($conn, $sql);
$output['carouselItems'] = mysqli_fetch_all($result, MYSQLI_ASSOC);*/

//2.科技产品
$sql = "SELECT pid,title,pic,price,href FROM kj_index_product WHERE seq_recommended>0 ORDER BY seq_recommended  LIMIT 8";
$result = mysqli_query($conn, $sql);
